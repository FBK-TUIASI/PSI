...
void UART0_PutByteHex(unsigned char input);					// afiseaza un octet in hexa
unsigned char UART0_GetDigitHex(void);							// preia un digit hexa
unsigned char UART0_GetByteHex(void);							// preia un octet hexa